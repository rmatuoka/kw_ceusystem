class UserMailer < ActionMailer::Base
  ...
  def contact(contact)
    @contato = contact
    mail(:to => "douglas@ceusystem.com.br", :bcc => "log@korewa.com.br", :subject => "Contato Via Site")
  end
  
  def works(work)
      @work = work
      attachments[@work.curriculum_file_name] = File.read(@work.curriculum.path)
      mail(:to => "rh@ceusystem.com.br", :bcc => "log@korewa.com.br", :subject => "Ceu System - Curriculo via Site")
